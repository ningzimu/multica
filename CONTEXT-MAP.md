...
- [Outbound Webhooks](./server/internal/integrations/outwebhook/CONTEXT.md): publishes selected Multica product events to administrator-configured external destinations.
...
- **Multica product domains -> Outbound Webhooks**: product events are translated into matching subscription deliveries.
- **Outbound Webhooks -> External Receivers**: each matching subscription delivers an externally consumable event to its configured destination.
